function calcular() {
    ...
    volumes.forEach(volume => {
        ...
        linha.innerHTML = `
            ...
            <td class="produto-a">${(consumoA * volume).toFixed(1)} g</td>
            <td class="produto-a">R$ ${custoA.toFixed(2)}</td>
            <td class="produto-b">${(consumoB * volume).toFixed(1)} g</td>
    ...
    document.getElementById('resumo').innerHTML = `
        ...
        <p>• Produto A: R$ ${custoPorM3A.toFixed(4)}/m³ (${consumoA} g/m³ × R$ ${precoA}/kg)</p>
        <p>• Produto B: R$ ${custoPorM3B.toFixed(4)}/m³ (${consumoB} g/m³ × R$ ${precoB}/kg)</p>
